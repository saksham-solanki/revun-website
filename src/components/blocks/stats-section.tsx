...
export function StatsSection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#E8F2FE] py-12 md:py-16">
      {/* Thin decorative lines at top and bottom */}
      <div className="absolute inset-0" aria-hidden>
        <div className="absolute left-1/2 top-0 h-px w-[60%] -translate-x-1/2 bg-[#176FEB]/10" />
        <div className="absolute left-1/2 bottom-0 h-px w-[60%] -translate-x-1/2 bg-[#176FEB]/10" />
      </div>

      <div className="relative mx-auto max-w-6xl px-6">
        {/* Section badge */}
        <div className="mb-10 flex justify-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-[#176FEB]/20 bg-white px-4 py-1.5 text-xs font-medium text-[#555860] backdrop-blur-sm">
        ...
        <RevealOnScroll className="grid grid-cols-2 gap-y-12 md:grid-cols-4" stagger={0.1}>
          ...
          <motion.div variants={revealItem} className="relative flex flex-col items-center text-center">
            <span className="font-heading text-4xl font-bold tracking-tight text-[#0A1628] md:text-5xl">
              {units.toLocaleString()}+
            </span>
            <Sparkline data={sparklineData.units} width={64} height={20} color="rgba(74,145,240,0.5)" className="mt-2" />
            <span className="mt-2 text-sm font-medium text-[#555860]">Units on Platform</span>
          </motion.div>

          {/* Uptime */}
          <motion.div variants={revealItem} className="relative flex flex-col items-center text-center">
            <div className="absolute left-0 top-1/2 hidden h-12 w-px -translate-y-1/2 bg-[#176FEB]/10 md:block" aria-hidden />
            ...
            <span className="mt-2 text-sm font-medium text-[#555860]">Uptime</span>
          </motion.div>
          ...
          <motion.div variants={revealItem} className="relative flex flex-col items-center text-center">
            ...
            <span className="mt-2 text-sm font-medium text-[#555860]">Integrations</span>
          </motion.div>
          ...
          <motion.div variants={revealItem} className="relative flex flex-col items-center text-center">
            ...
            <span className="mt-2 text-sm font-medium text-[#555860]">Countries</span>
          </motion.div>
        </RevealOnScroll>
      </div>
    </section>
